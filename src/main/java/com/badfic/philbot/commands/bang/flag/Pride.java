...
class Pride extends BaseFlagCommand {
    ...
    public void execute(CommandEvent event) {
        ...
        try {
            ...
            try (InputStream prideFlagStream = getClass().getClassLoader().getResourceAsStream("flags/" + flagName + ".png")) {
            ...
            byte[] imageBytes = ImageUtils.makeOverlaidImage(prideImage, profilePic, ALPHA);
